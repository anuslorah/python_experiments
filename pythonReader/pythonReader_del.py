...
# create file, write to it, count occurrences of word in file, 
# return number of sentences written, delete file
def writeMyFile(word, logger, metrics):
  # open file, permission write, + denotes new file
  addFile = open("myFile.txt", "r+")
  ...
  with open("myFile.txt", "r") as file:
    ...
    # iii = input("\nDo you want to delete the file you created? Type y for yes: ").casefold()
    # if (iii == "y"):
    #   if os.path.exists("myFile.txt"):
    #     try:
    #       os.remove("myFile.txt")
    #       print("File deleted.\n")
    #       logger.debug('user created file has been removed')
    #     except OSError:
    #       logger.debug(" file in use, cannot delete")  
